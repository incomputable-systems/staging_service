...
__author__    = 'Incomputable LLC'
__email__     = 'info@incomputable-systems.com'
__copyright__ = 'Copyright 2023, Incomputable LLC'
__license__   = 'MIT'
...
# ------------------------------------------------------------------------------
base     = 'staging_service'
name     = 'incomputable.%s'      % base
mod_root = 'src/incomputable/%s/' % base
...
setup_args = {
    'name'               : name,
    'namespace_packages' : ['incomputable'],
    'version'            : version,
    'description'        : 'The Incomputable LLC Staging Service',
    'author'             : 'Incomputable LLC',
    'author_email'       : 'info@incomputable-systems.com',
    'maintainer'         : 'Incomputable LLC',
    'maintainer_email'   : 'info@incomputable-systems.com',
    'url'                : 'http://incomputable-systems.github.io/%s/' % name,
    'project_urls'       : {
        'Documentation': 'https://incomputable%s.readthedocs.io/en/latest/'  % base,
        'Source'       : 'https://github.com/incomputable-systems/%s/'       % name,
        'Issues'       : 'https://github.com/incomputable-systems/%s/issues' % name,
    },
    'license'            : 'MIT',
    'keywords'           : 'incomputable data staging',
    'python_requires'    : '>=3.8',
    'classifiers'        : [
    ...
    'packages'           : find_namespace_packages('src', include=['incomputable.*']),
    'package_dir'        : {'': 'src'},
    'scripts'            : [
                            'bin/incomputable-staging-service',
                           ],
